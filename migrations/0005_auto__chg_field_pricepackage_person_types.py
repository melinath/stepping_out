...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PricePackage.person_types'
        db.alter_column('stepping_out_pricepackage', 'person_types', self.gf('stepping_out.pricing.fields.SlugMultipleChoiceField')())


    def backwards(self, orm):
        
        # Changing field 'PricePackage.person_types'
        db.alter_column('stepping_out_pricepackage', 'person_types', self.gf('stepping_out.pricing.fields.SlugListField')())
