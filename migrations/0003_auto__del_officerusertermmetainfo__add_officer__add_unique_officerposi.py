...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('stepping_out_officer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('position', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stepping_out.OfficerPosition'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='officers', to=orm['auth.User'])),
            ('term', self.gf('django.db.models.fields.related.ForeignKey')(related_name='officers', to=orm['stepping_out.Term'])),
            ('start', self.gf('django.db.models.fields.DateField')()),
            ('end', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('stepping_out', ['Officer'])

        # Adding unique constraint on 'OfficerPosition', fields ['slug']
        db.create_unique('stepping_out_officerposition', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'OfficerPosition', fields ['slug']
        db.delete_unique('stepping_out_officerposition', ['slug'])
        ...
        db.delete_table('stepping_out_officer')
