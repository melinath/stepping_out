...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OfficerUserTermMetaInfo'
        db.create_table('stepping_out_officerusertermmetainfo', (
            ...
            ('term', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stepping_out.Term'])),
            ('start', self.gf('django.db.models.fields.DateField')()),
            ('end', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('stepping_out', ['OfficerUserTermMetaInfo'])

        # Adding field 'OfficerPosition.slug'
        db.add_column('stepping_out_officerposition', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=50, db_index=True), keep_default=False)

        # Adding field 'OfficerPosition.description'
        db.add_column('stepping_out_officerposition', 'description', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'OfficerPosition.category'
        db.add_column('stepping_out_officerposition', 'category', self.gf('django.db.models.fields.CharField')(default='o', max_length=1), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'OfficerUserTermMetaInfo'
        db.delete_table('stepping_out_officerusertermmetainfo')

        # Deleting field 'OfficerPosition.slug'
        db.delete_column('stepping_out_officerposition', 'slug')

        # Deleting field 'OfficerPosition.description'
        db.delete_column('stepping_out_officerposition', 'description')

        # Deleting field 'OfficerPosition.category'
        db.delete_column('stepping_out_officerposition', 'category')
    ...
    models = {
        ...
        'stepping_out.officerposition': {
            ...
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'officer_positions'", 'symmetrical': 'False', 'through': "orm['stepping_out.OfficerUserTermMetaInfo']", 'to': "orm['auth.User']"})
        },
        'stepping_out.officerusertermmetainfo': {
            'Meta': {'object_name': 'OfficerUserTermMetaInfo'},
            'end': ('django.db.models.fields.DateField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'officer_position': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['stepping_out.OfficerPosition']"}),
            'start': ('django.db.models.fields.DateField', [], {}),
            'term': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['stepping_out.Term']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        ...
        'stepping_out.term': {
            ...
            'positions': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'terms'", 'symmetrical': 'False', 'through': "orm['stepping_out.OfficerUserTermMetaInfo']", 'to': "orm['stepping_out.OfficerPosition']"}),
            'start': ('django.db.models.fields.DateField', [], {})
        }
    }
