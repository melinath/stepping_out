...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field subscribed_officer_positions on 'MailingList'
        db.create_table('mail_mailinglist_subscribed_officer_positions', (
        ...
        db.create_unique('mail_mailinglist_subscribed_officer_positions', ['mailinglist_id', 'officerposition_id'])

        # Adding M2M table for field moderator_officer_positions on 'MailingList'
        db.create_table('mail_mailinglist_moderator_officer_positions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mailinglist', models.ForeignKey(orm['mail.mailinglist'], null=False)),
            ('officerposition', models.ForeignKey(orm['stepping_out.officerposition'], null=False))
        ))
        db.create_unique('mail_mailinglist_moderator_officer_positions', ['mailinglist_id', 'officerposition_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field subscribed_officer_positions on 'MailingList'
        db.delete_table('mail_mailinglist_subscribed_officer_positions')

        # Removing M2M table for field moderator_officer_positions on 'MailingList'
        db.delete_table('mail_mailinglist_moderator_officer_positions')
