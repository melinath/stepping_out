...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Registration.first_name'
        db.add_column('workshops_registration', 'first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)

        # Adding field 'Registration.last_name'
        db.add_column('workshops_registration', 'last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)

        # Changing field 'Registration.user'
        db.alter_column('workshops_registration', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))


    def backwards(self, orm):
        
        # Deleting field 'Registration.first_name'
        db.delete_column('workshops_registration', 'first_name')

        # Deleting field 'Registration.last_name'
        db.delete_column('workshops_registration', 'last_name')

        # Changing field 'Registration.user'
        db.alter_column('workshops_registration', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
