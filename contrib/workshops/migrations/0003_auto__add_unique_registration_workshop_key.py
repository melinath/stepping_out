...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Registration', fields ['workshop', 'key']
        db.create_unique('workshops_registration', ['workshop_id', 'key'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Registration', fields ['workshop', 'key']
        db.delete_unique('workshops_registration', ['workshop_id', 'key'])
