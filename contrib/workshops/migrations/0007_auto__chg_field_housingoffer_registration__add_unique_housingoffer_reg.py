...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HousingOffer.registration'
        db.alter_column('workshops_housingoffer', 'registration_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['workshops.Registration'], unique=True))

        # Adding unique constraint on 'HousingOffer', fields ['registration']
        db.create_unique('workshops_housingoffer', ['registration_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'HousingOffer', fields ['registration']
        db.delete_unique('workshops_housingoffer', ['registration_id'])

        # Changing field 'HousingOffer.registration'
        db.alter_column('workshops_housingoffer', 'registration_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workshops.Registration']))
    ...
    models = {
        ...
        'workshops.housingoffer': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'num_ideal': ('django.db.models.fields.PositiveIntegerField', [], {'default': '2'}),
            'num_max': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3'}),
