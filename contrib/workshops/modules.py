# Note to self: Redo this as a workshop management section and a separate workshop
# registration section. Maybe do a custom registration of the registration section
# to register it once for each open workshop?
# Or, have a factory function that generates for each one? Or, just give it
# multiple urls for each workshop... that'd be better.
