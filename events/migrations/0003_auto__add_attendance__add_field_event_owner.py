...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('events_attendance', (
            ...
            ('rsvp', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
        ))
        db.send_create_signal('events', ['Attendance'])

        # Adding field 'Event.owner'
        db.add_column('events_event', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='events', to=orm['auth.User']), keep_default=False)
