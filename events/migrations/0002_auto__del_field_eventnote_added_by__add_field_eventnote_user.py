...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'EventNote.added_by'
        db.delete_column('events_eventnote', 'added_by_id')

        # Adding field 'EventNote.user'
        db.add_column('events_eventnote', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='event_notes', to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # We cannot add back in field 'EventNote.added_by'
        raise RuntimeError(
            "Cannot reverse this migration. 'EventNote.added_by' and its values cannot be restored.")

        # Deleting field 'EventNote.user'
        db.delete_column('events_eventnote', 'user_id')
